    ...
    <>
      <div className='pb-40 flex flex-wrap gap-3 justify-center px-5'>
        {filteredCoins?.map((coin) => (
          <div  key={coin.id} className="w-60 h-20 mb-8 bg-blue-900 rounded-lg text-xs hover:shadow hover:shadow-indigo-900 ">
            <div style={{ background: '#02072F'}} className="w-60 h-auto  rounded-lg mt-1 p-2 hover:cursor-pointer ">
              ...
              <div className="flex items-center justify-between  border-t-ingo-500 py-1">
                ...
                <p className={coin.price_change_percentage_24h > 0 ? "text-green-700 " : "text-red-600 "}>
